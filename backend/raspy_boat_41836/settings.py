"""
Django settings for raspy_boat_41836 project.
...
ROOT_URLCONF = 'raspy_boat_41836.urls'
...
WSGI_APPLICATION = 'raspy_boat_41836.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_boat_41836 API",
    "DESCRIPTION": "API documentation for raspy_boat_41836 App",
    "VERSION": "v1",
}
